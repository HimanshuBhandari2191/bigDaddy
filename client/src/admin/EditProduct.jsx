...
const EditProduct = () => {
  ...
  const [formData, setFormData] = useState({ name: '', description: '', price: '', size: '', stock: '' });
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      ...
      setFormData({ name: data.name, description: data.description, price: data.price, size: data.size, stock: data.stock });
    };
    fetchProduct();
  }, [id]);
